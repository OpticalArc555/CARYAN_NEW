...
//             <div>
//               {/* <p className="font-bold text-2xl">caryanamindia</p> */}
//               <img
//                 src={cartechlogo2}
//                 alt="logo"
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Box display="flex" alignItems="center">
            <Box>
              ...
              <Link href="#" color="inherit" variant="body2">About</Link><br />
              <Link href="#" color="inherit" variant="body2">Careers With Us</Link><br />
              <Link href="#" color="inherit" variant="body2">Terms & Conditions</Link><br />
              <Link href="#" color="inherit" variant="body2">Privacy Policy</Link><br />
              <Link href="#" color="inherit" variant="body2">Corporate Policies</Link><br />
              <Link href="#" color="inherit" variant="body2">Investors</Link><br />
              <Link href="#" color="inherit" variant="body2">FAQs</Link><br />
            </Box>
          </Box>
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          ...
          <Link href="#" color="inherit" variant="body2">Feedback</Link><br />
          <Link href="#" color="inherit" variant="body2">Contact Us</Link><br />
          <Link href="#" color="inherit" variant="body2">Advertise with Us</Link><br />
          <Link href="#" color="inherit" variant="body2">Become Partner Dealer</Link><br />
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
          <Typography variant="h6" gutterBottom>
            OTHERS
          </Typography>
          <Link href="#" color="inherit" variant="body2">Emergency Response</Link><br />
          <Link href="#" color="inherit" variant="body2">Car Sales Trends</Link><br />
          <Box>
            <Typography variant="h6" gutterBottom>
              Follow Us
            </Typography>
...
<Divider sx={{ my: 2, bgcolor: '#fff' }} /> {/* Divider added here */}

          <Typography variant="h6" gutterBottom>
            EXPERIENCE CARYANAM APP
          </Typography>
          <IconButton href="#" color="inherit" aria-label="android" sx={{ fontSize: 40 }}>
