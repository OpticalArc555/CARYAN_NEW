                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        <div className="h-full pr-6">
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                We would love to speak with you. Fill out the form provided below or email us your request to <a href="mailto:techsupport@caryanamindia.com" className="text-blue-600">techsupport@caryanamindia.com</a>
                            </p>
                            <ul className="mb-6 md:mb-0 space-y-4">
                                <li className="flex">
                                    ...
                                    <div className="ml-4">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">caryanamindia Headquarters</p>
