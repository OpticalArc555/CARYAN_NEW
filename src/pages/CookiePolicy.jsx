      ...
      <div className="w-full">
        ...
        <div className="max-w-screen-3xl mx-4 my-6 md:ml-20 md:mr-12 lg:ml-36 lg:mr-24">
          ...
          <p className="mt-8 text-lg">
            caryanamindia is committed to protecting your privacy. We aim to
          ...
          <p className="mt-4 text-lg">
            Some features of our website and some caryanamindia services rely on
          ...
          {/* <p className="mt-6 text-lg">By post: caryanamindia Pvt. Ltd. 1128, 3rd floor, Rd Number 36, Jubilee Square, Jubilee Hills, Pune, Maharashtra 500033</p> */}
        </div>
      </div>
    </div>
  );
